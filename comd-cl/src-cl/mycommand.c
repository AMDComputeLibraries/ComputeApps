...
/// | \--defGrad    | -s          | 1.0           | 1D deformation gradient
///
/// Notes: 
/// 
...
///     $ ./CoMDParallel 
/// 
/// Or, equivalently if the code was built with MPI:
///
///     $ mpirun -np 1 ./CoMDParallel 
///
/// ------------------------------
///
...
/// potential type
///
///     $ ./CoMDParallel -e -p Cu01.eam.alloy 
/// 
...
/// Instead use:
///
///     $ ./CoMDParallel -e -t setfl -p Cu01.eam.alloy 
///
/// ------------------------------
///
...
/// arguments.
/// 
///     $ mpirun -np 8 ./CoMDParallel -i2 -j2 -k2
/// 
/// ------------------------------
///
...
///
///     $ mpirun -np 8 ./CoMDParallel -i2 -j2 -k2 -x 40 -y 40 -z 40
///
/// ------------------------------
///
...
///
///     $ mpirun -np 8 ./CoMDParallel -i2 -j2 -k2 -x 40 -y 40 -z 40 -N 10000 -n 100
///
...
Command parseCommandLine(int argc, char** argv)
{
   ...
   addArg("defGrad",    's', 1, 'd',  &(cmd.defGrad),      0,             "1D deformation gradient");
   addArg("useGpu",     'g', 0, 'i',  &(cmd.useGpu),       0,             "use GPU for computation");
